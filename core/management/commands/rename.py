...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        files_to_rename = ['src_backend/settings/base.py', 'src_backend/wsgi.py',
                           'manage.py', 'core/management/commands/rename.py']
        folder_to_rename = 'src_backend'

        for f in files_to_rename:
            with open(f, 'r') as file:
                filedata = file.read()

            filedata = filedata.replace('src_backend', new_project_name)
